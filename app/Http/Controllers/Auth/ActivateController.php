...
class ActivateController extends Controller
{
    ...
    private static $pricingRoute = 'payment.pricing';
    ...
    public static function getPricingRoute()
    {
        return self::$pricingRoute;
    }
    ...
    public static function activePricingRedirect($user, $currentRoute)
    {
        if ($user->activated) {
            Log::info('Activated user attempted to visit '.$currentRoute.'. ', [$user]);
            ...
            return redirect()->route(self::getPricingRoute())
                ->with('status', 'info')
                ->with('message', trans('auth.alreadyActivated'));
        }
    ...
    public function activePricing(){
        ...
        return $this->activePricingRedirect($user, $currentRoute)
            ->with('status', 'info')
            ->with('message', trans('auth.alreadyActivated'));
    }
