...
@foreach ($roles as $role)
    @if ($role->name == 'User')
        ...
        @endphp
    @elseif ($role->name == 'Translator')
        @php
            $levelIcon        = 'person_outline';
            $levelName        = 'Translator';
            $levelBgClass     = 'mdl-color--green-200';
            $leveIconlBgClass = 'mdl-color--green-500';
        @endphp
        ...
        <div class="panel @if ($user->activated == 1) panel-success @else panel-danger @endif">
          ...
          <div class="panel-body">
            ...
            <div class="well">
              <div class="row">
                <div class="col-sm-6">
                  <img src="@if ($user->profile && $user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" alt="{{ $user->id }}" id="" class="img-circle center-block margin-bottom-2 margin-top-1 user-image">
                </div>
