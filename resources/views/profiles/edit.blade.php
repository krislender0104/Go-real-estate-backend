...
@section('breadcrumbs')
	...
	<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="active">
		<a itemprop="item" href="{{ url('/profile/'.Auth::user()->id.'/edit') }}" class="hidden">
			<span itemprop="name">
...
@section('content')
	@if (Auth::user()->id == $user->id)
		<div class="container">
			<div class="mdl-grid full-grid margin-top-0 padd-top-bottom-40">
				<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
					<div class="mdl-card card-wide" style="width:100%;" itemscope itemtype="http://schema.org/Person">
						<div class="mdl-user-avatar">
							<div id="avatar_selector_userimage" class="avatar-selecter @if($user->profile->avatar_status == 0) active-avatar-selecter @endif">
								...
								{!! Form::open(array('route' => 'avatar.upload', 'method' => 'POST', 'name' => 'avatarDropzone','id' => 'avatarDropzone', 'class' => 'form single-dropzone dropzone single', 'files' => true)) !!}
									@if($user->profile->avatar)
										<img id="user_selected_avatar" class="user-avatar" src="{{ $user->profile->avatar }}" alt="{{ $user->id }}">
									@else
						...
						{!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->id],  'class' => '', 'id' => 'edit_profile_form', 'role' => 'form', 'enctype' => 'multipart/form-data' ]) !!}
							...
							<div class="mdl-card__menu">
								...
								<a id="avatar_selection_menu" class="mdl-button mdl-button--icon  start-hidden mdl-js-button mdl-js-ripple-effect mdl-color-text--white">
