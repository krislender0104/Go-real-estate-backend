			  	...
			  	<div class="mdl-cell--6-col-tablet mdl-cell--1-offset-tablet mdl-cell--6-col-desktop mdl-cell--3-offset-desktop ">
			       	<div class="demo-card-full mdl-card mdl-shadow--2dp">
		                ...
		                <div class="mdl-card__supporting-text ">
							...
							<p><a href='/Auth/activation' class="mdl-button mdl-js-button mdl-js-ripple-effect center mdl-color--primary mdl-color-text--white mdl-button--raised margin-bottom-1 margin-top-2">{{ trans('auth.clickHereResend') }}</a></p>
		                </div>
		                <div class="mdl-card__actions mdl-card--border">

		                    {!! HTML::link(url('/Auth/logout'), trans('auth.logout'), array('id' => 'logout', 'class' => 'mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect right')) !!}
