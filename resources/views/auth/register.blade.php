...
@section('content')
    ...
    <div class="col-lg-10 col-md-12 login-box">
        <div class="row">
            <div class="col-lg-8 col-md-8 log-det">
                <div class="small-logo mb-4">
                <svg height="34" style="fill-rule:evenodd; fill:#1572E8 " viewBox="0 0 4271.87 748.74" width="180" xmlns="http://www.w3.org/2000/svg">
                ...
                {{ csrf_field() }}
                        ...
                        <!-- <div class="col-sm-6">
                            <div class="text-box-cont">
                                <div class="input-group mb-4">
                                    ...
                                    {!! Form::text('name', null, array('id' => 'name', 'class' => 'form-control', 'pattern' => '[A-Z,a-z,0-9]*' , 'placeholder'=>trans('auth.name'))) !!}
                        ...
                        <div class="col-sm-6">
                            <div class="text-box-cont">
                                <div class="input-group mb-4">
                                    ...
                                    {!! Form::email('email', null, array('id' => 'email', 'class' => 'form-control', 'placeholder'=>trans('auth.email') )) !!}
                        ...
                        <div class="col-sm-6">
                            <div class="text-box-cont">
                                <div class="input-group mb-4">
                                    ...
                                    {!! Form::text('first_name', null, array('id' => 'first_name', 'class' => 'form-control', 'pattern' => '[A-Z,a-z]*', 'placeholder'=>trans('auth.first_name'))) !!}
                        ...
                        <div class="col-sm-6">
                            <div class="text-box-cont">
                                <div class="input-group mb-4">
                                    ...
                                    {!! Form::text('last_name', null, array('id' => 'last_name', 'class' => 'form-control', 'pattern' => '[A-Z,a-z]*', 'placeholder'=>trans('auth.last_name'))) !!}
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleFormControlSelect2">Select UserType</label>
                        ...
                        <div class="col-sm-6">
                            <div class="text-box-cont">
                                <div class="input-group mb-4">
                                    ...
                                    {!! Form::password('password', array('id' => 'password', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>trans('auth.password')) ) !!}
                        ...
                        <div class="col-sm-6">
                            <div class="text-box-cont">
                                <div class="input-group mb-4">
                                    ...
                                    {!! Form::password('password_confirmation', array('id' => 'password_confirmation', 'class' => 'form-control', 'required' => 'required', 'placeholder'=>trans('auth.confirmPassword')) ) !!}
                ...
                <div class="row">
                    <div class="text-box-cont">
                        ...
                        <div class="input-group mb-5">
                            ...
                            {!! Form::select('user', array('Translator' => 'Translator', 'User' => 'User'), 'User', ['id' => 'userSelect' ,'class' => 'form-control', 'style'=> 'color: black;']); !!} -->
                        </div>
                        
                        <div class="mb-4">
                            {!! Form::button('<span class="">Register</span>
                            <div class="input-group center">
                            </div>', array('class' => 'btn btn-primary btn-round','style'=>'text-transform: uppercase;', 'type' => 'submit','id'
                            => 'submit')) !!}
                            {!! Form::close() !!}
                        </div>

                        <div class="row mb-5">
                            <p class="forget-p">Do you have an account? <span><a href = "/signup">Sign Up Now</a></span></p>
                        </div>
                        <!-- <div class="row">
            ...
            <div class="col-lg-4 col-md-4 box-de">
                <div class="inn-cover">
                    <div class="ditk-inf">
                        ...
                        <p>If you have your account please login by clicking the SignIn Button</p>
                        <a href="/login">
