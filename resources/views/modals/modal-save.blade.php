  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style = "position: absolute;left: 28px;top: 0px;">{{ Lang::get('modals.confirm_modal_title_text') }} </h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        {!! Form::button('<i class="fa fa-fw '.Lang::get('modals.confirm_modal_button_save_icon').'" aria-hidden="true"></i> ' . Lang::get('modals.confirm_modal_button_save_text'), array('class' => 'btn btn-success pull-right btn-flat', 'type' => 'submit', 'id' => 'confirm' )) !!}
      </div>
    </div>
  </div>
</div>